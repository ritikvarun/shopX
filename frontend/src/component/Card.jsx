...
function Card({ name, image, id, price }) {
    ...
    return (
        <div
            className='w-full max-w-[280px] bg-white rounded-2xl overflow-hidden cursor-pointer group border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1'
